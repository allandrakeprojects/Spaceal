                    ...
                    if (currentQuestion < questions.Length)
                    {
                        ...
                        if (questions[currentQuestion].image || questions[currentQuestion].imageURL != String.Empty)    // If we have a question image, display it. Otherwise, hide the image object
                        {
                            ...
                            if (imageObject)
                            {
                                ...
                                else // Otherwise, take the image that is assigned locally ( from inside Unity )
                                {
                        ...
                        for (index = 0; index < questions[currentQuestion].answers.Length; index++)//  answerObjects.Length; index++)
                        {
                            ...
                            {
                                if (questions[currentQuestion].answers[index].soundURL != String.Empty)
                                {
                            ...
                            {
                                // If we have an image URL, try to load it
                                if (questions[currentQuestion].answers[index].imageURL != String.Empty)
                                {
        ...
        public void ChooseAnswer(Transform answerSource)
        {
            ...
            if (askingQuestion == true)
            {
                ...
                if (questions[currentQuestion].answers[answerIndex].isCorrect == false)
                {
                    ...
                    // Display the bonus text
                    // adpd update
                    if (bonusObject) bonusObject.Find("Text").GetComponent<Text>().text = "+1";
        ...
        public void ShowResult(bool isCorrectAnswer)
        {
            ...
            if (questions[currentQuestion].followup != String.Empty || questions[currentQuestion].followupImage || questions[currentQuestion].followupImageURL != String.Empty || questions[currentQuestion].followupSound || questions[currentQuestion].followupSoundURL != String.Empty)
            {
                ...
                if (questionObject.Find("ButtonPlaySound"))
                {
                    ...
                    if (questionObject.Find("ButtonPlaySound"))
                    {
                        if (questions[currentQuestion].followupSoundURL != String.Empty)
                        {
